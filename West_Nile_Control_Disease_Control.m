function [tau,ul,ua,X,J,J_comp,final_treatment_time,X0,T] = West_Nile_Control_Disease_Control(N,K,Tf, larvicide_type,ul,ua)
...
for i=1:N
 ...
 %Must wait at least one day between subsequent treatments
 if i~=1
